...
ButtonFramePlus = tk.Frame(calculations_frame,width=75,height=60,bg="#df7fd5")
ButtonFramePlus.place(x=388,y=210)
tk.Button(ButtonFramePlus,text="+",bg="#df7fd5",fg="#f4b6ed").place(x=0,y=0,width=75,height=60)

ButtonFrameMinus = tk.Frame(calculations_frame,width=75,height=60,bg="#df7fd5")
ButtonFrameMinus.place(x=388,y=300)
tk.Button(ButtonFrameMinus,text="-",bg="#df7fd5",fg="#f4b6ed").place(x=0,y=0,width=75,height=60)

ButtonFrameEqual = tk.Frame(calculations_frame,width=75,height=60,bg="#df7fd5")
ButtonFrameEqual.place(x=388,y=390)
tk.Button(ButtonFrameEqual,text="=",bg="#df7fd5",fg="#f4b6ed").place(x=0,y=0,width=75,height=60)
