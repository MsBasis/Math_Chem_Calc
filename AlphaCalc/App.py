...
ButtonFrame_1 = tk.Frame(buttons_frame,width=60,height=60,bg="#df7fd5")
...
ButtonFrame_4 = tk.Frame(buttons_frame,width=60,height=60,bg="#df7fd5").place(x=120,y=210)
...
ButtonFrame_7 = tk.Frame(buttons_frame,width=60,height=60,bg="#df7fd5").place(x=200,y=210)
...
ButtonFrame_0 = tk.Frame(buttons_frame,width=60,height=240,bg="#df7fd5").place(x=280,y=210)
